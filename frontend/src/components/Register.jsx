...
const Register = () => {
  ...
  const handleChange = (e) => {
    const { name, value } = e.target; // [name: email, value: "ornek@mail.com"]
    setFormData({
      ...formData,
      [name]: value,
    });
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center space-x-5 justify-center">
            <svg fill="none" viewBox="0 0 397 94" height="auto" width={85} xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill="url(#paint2_linear_501_142)" d="M0 83.2195C0 80.5524 1.96995 78.3902 4.4 78.3902H83.6C86.0301 78.3902 88 80.5524 88 83.2195V89.1707C88 91.8379 86.0301 94 83.6 94H4.4C1.96995 94 0 91.8379 0 89.1707V83.2195Z" />
              <defs>
          ...
          <form className="mt-5" onSubmit={handleSubmit}>
            ...
            {/* 1-ci dizayndakı kimi, "Sign in with Google" və "Sign in with Apple" düymələri */}
              ...
              <div>
                ...
                >
                  <svg viewBox="0 0 24 24" height={25} width={25} xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path opacity=".2" d="M12,0.25c2.9750366,0,5.6829224,1.0983887,7.7792969,2.8916016l0.144165-0.1375122 l-0.110014-0.0958166C17.7089558,1.0843592,15.00354,0,12,0C5.3725586,0,0,5.3725586,0,12c0,0.0421753,0.0058594,0.0828857,0.0062866,0.125C0.0740356,5.5558472,5.4147339,0.25,12,0.25z" fill="#FFF" />
                  </svg>
