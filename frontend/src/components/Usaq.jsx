...
/*---------------------- Main EcommerceApp Component for Usaq ----------------------*/
const Usaq = () => {
  // Price filter states
  ...
  // Send "Usaq" category and price range filter to the backend
  ...
  // Calculate dynamic size list from backend products
  ...
  // If a size is selected, apply additional frontend filtering
    ...
    <div className="container mt-20 mx-auto px-4 py-8">
      ...
      <nav className="text-sm mb-4">
        <ol className="flex items-center space-x-2">
          ...
          <li className="text-gray-500">/</li>
          <li className="text-gray-800">Usaq</li>
        </ol>
      </nav>

      <div className="flex flex-col lg:flex-row gap-6">
        {/* Filter Panel (for both desktop and mobile) */}
        <div
        ...
        <div className="flex-1">
          ...
          {/* Pagination and more can be added here if needed */}
        </div>
      </div>
    </div>
  );
